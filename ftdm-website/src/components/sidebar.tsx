  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed inset-y-0 left-0 z-50 w-80 bg-background border-r border-border lg:hidden"
      >
      ...
      {/* Desktop Sidebar */}
      <div className="hidden lg:flex lg:w-80 lg:flex-col lg:border-r lg:border-border lg:bg-background lg:overflow-hidden lg:shrink-0">
        <div className="flex h-full flex-col">
          {/* Header */}
