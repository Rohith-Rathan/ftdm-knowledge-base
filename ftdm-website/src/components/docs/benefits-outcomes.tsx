...
import { 
  ...
  CalendarFileUnlz4,
  CalendarFileUnzst,
  CalendarFileUnbrotli,
  CalendarFileUndeflate,
  CalendarFileUngzip,
  CalendarFileUncompress,
  CalendarFileUncompressAll,
  CalendarFileCompressAll,
  CalendarFileArchiveAll,
  CalendarFileExtractAll,
  CalendarFileZipAll,
  CalendarFileRarAll,
  CalendarFile7zAll,
  CalendarFileTarAll,
  ...
  CalendarFileLz4All,
  CalendarFileZstAll,
  CalendarFileBrotliAll,
  CalendarFileDeflateAll,
  CalendarFileGzipAll,
  CalendarFileCompressAll as CalendarFileCompressAllIcon,
  CalendarFileUncompressAll as CalendarFileUncompressAllIcon,
  CalendarFileArchiveAll as CalendarFileArchiveAllIcon,
  CalendarFileExtractAll as CalendarFileExtractAllIcon,
  CalendarFileZipAll as CalendarFileZipAllIcon,
  CalendarFileRarAll as CalendarFileRarAllIcon,
  CalendarFile7zAll as CalendarFile7zAllIcon,
  CalendarFileTarAll as CalendarFileTarAllIcon,
  CalendarFileGzAll as CalendarFileGzAllIcon,
  CalendarFileBz2All as CalendarFileBz2AllIcon,
  CalendarFileXzAll as CalendarFileXzAllIcon,
  CalendarFileLz4All as CalendarFileLz4AllIcon,
  CalendarFileZstAll as CalendarFileZstAllIcon,
  CalendarFileBrotliAll as CalendarFileBrotliAllIcon,
  CalendarFileDeflateAll as CalendarFileDeflateAllIcon,
  CalendarFileGzipAll as CalendarFileGzipAllIcon
} from 'lucide-react'
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {category.items.map((item, itemIndex) => (
                  <motion.div
                    ...
                    className={`p-6 rounded-xl border-2 ${category.borderColor} ${category.bgColor} hover:shadow-lg transition-all duration-300`}
                  >
