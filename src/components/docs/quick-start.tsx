    ...
    <section id="quick-start" className="py-16">
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {steps.map((step, index) => (
            <motion.div
              ...
              className="group relative p-8 rounded-2xl border border-border bg-card/50 hover:bg-card transition-all duration-300 shadow-sm hover:shadow-lg hover:shadow-blue-500/10"
            >
        ...
        <motion.div
          ...
          className="text-center p-8 rounded-xl border border-border bg-gradient-to-r from-green-500/10 to-blue-500/10 shadow-sm hover:shadow-lg hover:shadow-green-500/10 transition-all duration-300"
        >
